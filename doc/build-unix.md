...
Note
---------------------
Always use absolute paths to configure and compile bitcoingreen and the dependencies,
...
# Pick some path to install BDB to, here we create a directory within the bitcoingreen directory
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, bitcoingreen should be built with a non-executable stack
