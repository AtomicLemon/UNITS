...
In order to support loading of multiple wallets in units-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is units.cpp.
...
Changes to units.cpp
----------------------
units.cpp is the entry point into units-qt, and as such, will require some minor modifications to provide hooks for
