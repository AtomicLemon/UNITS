...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000324b31d6f48bae92e8cdb8c5d1e5ae4592ec5678dc187c76f06c882868e"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1553976174, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1553976378;
        genesis.nNonce = 379722;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000b41b6d37f944dfa1f4b6649dcbca918a42f7ff1e6087e34fc374279b438"));

        vFixedSeeds.clear();
        vSeeds.clear();

        // Testnet Units addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet Units script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet Units BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Units BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet units BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Units: 1 day
        nTargetSpacing = 2 * 60;        // Units: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1553976544;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 213083;

        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 29333;
        assert(hashGenesisBlock == uint256("0x00000dbca52db34ee31a02e3ebf143b79740d685a73de0ff945f166fd14de38a"));
