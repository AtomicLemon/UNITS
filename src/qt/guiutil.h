...
/** Utility functions used by the Units Qt UI.
 */
namespace GUIUtil
{
...
// Render UNITS addresses in monospace font
...
// Parse "units:" URI into recipient object, return true on successful parsing
