                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Units Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a UNITS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and units: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Units Core"), this);
    aboutAction->setStatusTip(tr("Show information about Units Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Units"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your UNITS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified UNITS addresses"));
    ...
    openAction->setStatusTip(tr("Open a units: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Units Core help message to get a list with possible Units command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Units Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Units network", "", count));
}
...
{
    QString strTitle = tr("Units Core"); // default title
