 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Units (http://www.savebitcoin.io),
 * which enables instant payments to anyone, anywhere in the world. Units uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    if (mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Units Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";
    ...
    try {
        ...
        if (fDaemon) {
            fprintf(stdout, "Units server starting\n");
