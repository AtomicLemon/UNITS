...
#   c) node1 mines 32 blocks, so now node 0 has 500000UNITS, node 1 has 4250UNITS, node2 has none.
#   d) node0 sends 601 UNITS to node2, in two transactions (301 UNITS, then 300 UNITS).
