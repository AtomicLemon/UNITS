...
This means one can have an always-on unitsd instance running, and another local unitsd/units-qt instance which connects to this node and receives blocks from it.
