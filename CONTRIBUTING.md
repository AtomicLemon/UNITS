Contributing to Units Core
==================================

The Units Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Units Core project, and is not to be
confused with overall Units Network Protocol consensus changes.

Whether a pull request is merged into Units Core rests with the project merge
...
Patches that change Units consensus rules are considerably more involved than
...
Where a patch set proposes to change the Units consensus, it must have been
...
The project leader is the release manager for each Units Core release.
